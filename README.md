...
Docker image for running version 1.16.1 of [OSTicket](http://osticket.com/).
...
OSTicket is being served by [nginx](http://wiki.nginx.org/Main) using [PHP-FPM](http://php-fpm.org/) with PHP 8.0.
